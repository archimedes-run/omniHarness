...
SEARCH_PROVIDERS: list[SearchProvider] = [
    ...
    SearchProvider(
        ...
        use="OmniHarness.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="OmniHarness.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="OmniHarness.community.firecrawl.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    ...
    WebProvider(
        ...
        use="OmniHarness.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="OmniHarness.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="OmniHarness.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
]
