...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "Create your own skill to release the power of OmniHarness. With customized skills,\nOmniHarness can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. OmniHarness is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but OmniHarness could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "OmniHarness's official website",
    githubTooltip: "OmniHarness on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "OmniHarness on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About OmniHarness",
    logout: "Log out",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to OmniHarness",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate OmniHarness faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how OmniHarness looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "OmniHarness automatically learns from your conversations in the background. These memories help OmniHarness understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of OmniHarness.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "OmniHarness only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "OmniHarness",
