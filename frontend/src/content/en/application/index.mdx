...
description: OmniHarness App is the reference implementation of what a production OmniHarness experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  OmniHarness App is a complete Super Agent application built on top of OmniHarness
...
OmniHarness App is the reference implementation of what a production OmniHarness experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The OmniHarness App runs as four services behind a single nginx reverse proxy:
...
- **LangGraph**: the OmniHarness Harness runtime. Manages thread state, agent execution, and streaming.
...
| Agent runtime     | LangGraph, LangChain, OmniHarness Harness                               |
| Reverse proxy     | nginx                                                                |
