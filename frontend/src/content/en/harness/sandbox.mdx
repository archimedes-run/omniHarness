...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes OmniHarness capable of real action, not just
  conversation.
</Callout>
...
OmniHarness supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: omni-harness-sandbox)
...
| `.omni-harness/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
