...
description: This tutorial shows you how to use the OmniHarness Harness programmatically — importing and using OmniHarness directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the OmniHarness Harness programmatically — importing and using OmniHarness directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- OmniHarness repository cloned
