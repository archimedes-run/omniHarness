...
description: This tutorial shows you how to enable and use OmniHarness's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use OmniHarness's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.omni-harness/memory.json`:

```bash
cat backend/.omni-harness/memory.json
```
...
```
backend/.omni-harness/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own OmniHarness](/docs/tutorials/deploy-your-own-omniharness)
