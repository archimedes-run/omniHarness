# OmniHarness Frontend

Like the original OmniHarness 1.0, we would love to give the community a minimalistic and easy-to-use web interface with a more modern and flexible architecture.
