...
|----------|------|----------|
| omni-harness-nginx | {{nginx_status}} | {{nginx_uptime}} |
| omni-harness-frontend | {{frontend_status}} | {{frontend_uptime}} |
| omni-harness-gateway | {{gateway_status}} | {{gateway_uptime}} |
| omni-harness-langgraph | {{langgraph_status}} | {{langgraph_uptime}} |
...
### If the Test Passes
1. [ ] Visit http://localhost:2026 to start using OmniHarness
