"""OmniHarness Sandbox Provisioner Service.
        ...
        if exc.status == 404:
            ns = k8s_client.V1Namespace(
                metadata=k8s_client.V1ObjectMeta(
                    name=K8S_NAMESPACE,
                    labels={
                        "app.kubernetes.io/name": "omni-harness",
...
app = FastAPI(title="OmniHarness Sandbox Provisioner", lifespan=lifespan)
...
async def list_sandboxes():
    ...
    try:
        services = core_v1.list_namespaced_service(
            K8S_NAMESPACE,
            label_selector="app=omni-harness-sandbox",
        )
    except ApiException as exc:
        raise HTTPException(
