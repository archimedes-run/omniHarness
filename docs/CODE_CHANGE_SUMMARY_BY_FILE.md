...
### 2. `backend/packages/harness/omniharness/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/omniharness/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_omniharness_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "OmniHarness GitHub Repository", "url": "https://github.com/archimedes-run/omni-harness", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
