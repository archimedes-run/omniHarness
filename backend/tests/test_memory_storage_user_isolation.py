...
from omniharness.agents.memory.storage import FileMemoryStorage, create_empty_memory
...
class TestUserIsolatedStorage:
    def test_save_and_load_per_user(self, storage: FileMemoryStorage, base_dir: Path):
        ...
        with patch("omniharness.agents.memory.storage.get_paths", return_value=paths):
