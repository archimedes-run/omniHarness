...
from omniharness.utils.file_conversion import (
...
class TestDoConvert:
    ...
    def test_non_pdf_always_uses_markitdown(self, tmp_path):
        ...
        with patch(
            "omniharness.utils.file_conversion._convert_with_markitdown",
    ...
    def test_pdf_auto_uses_pymupdf4llm_when_dense(self, tmp_path):
        ...
        with (
            patch(
                "omniharness.utils.file_conversion._convert_pdf_with_pymupdf4llm",
                return_value=dense_text,
            ),
            patch(
                "omniharness.utils.file_conversion._pymupdf_output_too_sparse",
                return_value=False,
            ),
            patch("omniharness.utils.file_conversion._convert_with_markitdown") as mock_md,
        ):
    ...
    def test_pdf_explicit_markitdown_skips_pymupdf4llm(self, tmp_path):
        ...
        with (
            patch("omniharness.utils.file_conversion._convert_pdf_with_pymupdf4llm") as mock_pymu,
            patch(
                "omniharness.utils.file_conversion._convert_with_markitdown",
...
class TestGetPdfConverter:
    def test_reads_dict_backed_uploads_config(self):
        ...
        with patch("omniharness.utils.file_conversion.get_app_config", return_value=cfg):
...
class TestConvertFileToMarkdown:
    def test_small_file_runs_synchronously(self, tmp_path):
        ...
        with (
            patch("omniharness.utils.file_conversion._get_pdf_converter", return_value="auto"),
            patch(
                "omniharness.utils.file_conversion._do_convert",
