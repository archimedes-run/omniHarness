...
def test_bash_subagent_prompt_mentions_workspace_relative_paths() -> None:
    from omniharness.subagents.builtins.bash_agent import BASH_AGENT_CONFIG
...
def test_general_purpose_subagent_prompt_mentions_workspace_relative_paths() -> None:
    from omniharness.subagents.builtins.general_purpose import GENERAL_PURPOSE_CONFIG
