...
class TestBuildMinimalConfig:
    ...
    def test_search_tool_included(self):
        content = build_minimal_config(
            ...
            api_key_field="api_key",
            env_var="OPENAI_API_KEY",
            search_use="omniharness.community.tavily.tools:web_search_tool",
    ...
    def test_web_fetch_tool_included(self):
        content = build_minimal_config(
            ...
            api_key_field="api_key",
            env_var="OPENAI_API_KEY",
            web_fetch_use="omniharness.community.jina_ai.tools:web_fetch_tool",
    ...
    def test_sandbox_included(self):
        ...
        assert data["sandbox"]["use"] == "omniharness.sandbox.local:LocalSandboxProvider"
    ...
    def test_can_enable_container_sandbox_and_bash(self):
        content = build_minimal_config(
            ...
            api_key_field="api_key",
            env_var="OPENAI_API_KEY",
            sandbox_use="omniharness.community.aio_sandbox:AioSandboxProvider",
            include_bash_tool=True,
        )
        data = yaml.safe_load(content)
        assert data["sandbox"]["use"] == "omniharness.community.aio_sandbox:AioSandboxProvider"
    ...
    def test_cli_provider_does_not_emit_fake_api_key(self):
        content = build_minimal_config(
            provider_use="omniharness.models.openai_codex_provider:CodexChatModel",
            model_name="gpt-5.4",
            ...
            yaml.safe_dump(
                {
                    ...
                    "tools": [
                        ...
                        },
                        {
                            "name": "web_fetch",
                            "group": "web",
                            "use": "omniharness.community.jina_ai.tools:web_fetch_tool",
                            "timeout": 10,
                        },
                        {
                            "name": "image_search",
                            "group": "web",
                            "use": "omniharness.community.image_search.tools:image_search_tool",
                            "max_results": 5,
                        },
                        {"name": "ls", "group": "file:read", "use": "omniharness.sandbox.tools:ls_tool"},
                        {"name": "write_file", "group": "file:write", "use": "omniharness.sandbox.tools:write_file_tool"},
