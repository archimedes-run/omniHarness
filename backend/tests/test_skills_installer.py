"""Tests for omniharness.skills.installer — shared skill installation logic."""
...
from omniharness.skills.installer import (
...
class TestInstallSkillFromArchive:
    ...
    def test_copy_failure_does_not_leave_partial_install(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("omniharness.skills.installer.shutil.copytree", _copytree)
    ...
    def test_move_failure_cleans_reserved_target(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("omniharness.skills.installer.shutil.move", _move)
