"""Tests for omniharness.models.openai_codex_provider.CodexChatModel.
...
from omniharness.models.credential_loader import CodexCliCredential


def _make_model(**kwargs):
    from omniharness.models.openai_codex_provider import CodexChatModel

    cred = CodexCliCredential(access_token="tok-test", account_id="acc-test")
    with patch("omniharness.models.openai_codex_provider.load_codex_cli_credential", return_value=cred):
