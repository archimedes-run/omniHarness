...
def mock_app_config():
    ...
    with patch("omniharness.community.exa.tools.get_app_config") as mock_config:
...
def mock_exa_client():
    """Mock the Exa client."""
    with patch("omniharness.community.exa.tools.Exa") as mock_exa_cls:
...
class TestWebSearchTool:
    def test_basic_search(self, mock_app_config, mock_exa_client):
        ...
        from omniharness.community.exa.tools import web_search_tool
...
class TestWebFetchTool:
    def test_basic_fetch(self, mock_app_config, mock_exa_client):
        ...
        from omniharness.community.exa.tools import web_fetch_tool
