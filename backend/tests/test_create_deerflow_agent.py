"""Tests for create_omniharness_agent SDK entry point."""
...
from omniharness.agents.features import Next, Prev, RuntimeFeatures
...
def test_with_tools(mock_create_agent):
    ...
    create_omniharness_agent(model, tools=[tool])
...
def test_with_system_prompt(mock_create_agent):
    ...
    create_omniharness_agent(_make_mock_model(), system_prompt=prompt)
...
def test_features_mode(mock_create_agent):
    ...
    create_omniharness_agent(_make_mock_model(), features=feat)
...
def test_middleware_takeover(mock_create_agent):
    ...
    create_omniharness_agent(_make_mock_model(), middleware=[custom_mw])
...
def test_tool_deduplication(mock_create_agent):
    ...
    create_omniharness_agent(_make_mock_model(), tools=[user_clarification], features=RuntimeFeatures(sandbox=False))
...
def test_checkpointer_passthrough(mock_create_agent):
    ...
    create_omniharness_agent(_make_mock_model(), checkpointer=cp)
...
def test_loop_detection_always_present(mock_create_agent):
    mock_create_agent.return_value = MagicMock()
    create_omniharness_agent(_make_mock_model(), features=RuntimeFeatures(sandbox=False))
...
def test_plan_mode_adds_todo_middleware(mock_create_agent):
    mock_create_agent.return_value = MagicMock()
    create_omniharness_agent(_make_mock_model(), features=RuntimeFeatures(sandbox=False), plan_mode=True)
...
def test_full_chain_order(mock_create_agent):
    ...
    create_omniharness_agent(_make_mock_model(), features=feat, plan_mode=True)
