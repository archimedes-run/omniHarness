...
def reset_api_key_warned():
    ...
    import omniharness.community.serper.tools as serper_mod
...
def mock_config_with_key():
    with patch("omniharness.community.serper.tools.get_app_config") as mock:
...
class TestGetApiKey:
    def test_returns_config_key_when_present(self):
        with patch("omniharness.community.serper.tools.get_app_config") as mock:
            ...
            from omniharness.community.serper.tools import _get_api_key
...
class TestWebSearchTool:
    def test_basic_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("omniharness.community.serper.tools.httpx.Client") as mock_client_cls:
            mock_client_cls.return_value.__enter__.return_value.post.return_value = mock_resp

            from omniharness.community.serper.tools import web_search_tool
    ...
    def test_missing_api_key_logs_warning_once(self, mock_config_no_key, caplog):
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            with caplog.at_level(logging.WARNING, logger="omniharness.community.serper.tools"):
