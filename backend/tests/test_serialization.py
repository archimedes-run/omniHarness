"""Tests for omniharness.runtime.serialization."""
...
def test_serialize_none():
    from omniharness.runtime.serialization import serialize_lc_object
...
def test_serialize_channel_values_strips_pregel_keys():
    from omniharness.runtime.serialization import serialize_channel_values
...
def test_serialize_messages_tuple():
    from omniharness.runtime.serialization import serialize_messages_tuple
...
def test_serialize_dispatcher_messages_mode():
    from omniharness.runtime.serialization import serialize
