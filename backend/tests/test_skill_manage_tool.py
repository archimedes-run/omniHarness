...
skill_manage_module = importlib.import_module("omniharness.tools.skill_manage_tool")
...
def test_skill_manage_create_and_patch(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("omniharness.skills.security_scanner.get_app_config", lambda: config)
    refresh_calls = []
