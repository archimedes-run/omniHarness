...
from omniharness.config.app_config import apply_logging_level, logging_level_from_config
...
class TestApplyLoggingLevel:
    """Tests for ``apply_logging_level`` — verifies omniharness/app logger and handler levels."""
    ...
    def setup_method(self) -> None:
        ...
        self._original_omniharness_level = logging.getLogger("omniharness").level
    ...
    def teardown_method(self) -> None:
        ...
        logging.getLogger("omniharness").setLevel(self._original_omniharness_level)
        logging.getLogger("app").setLevel(self._original_app_level)

    def test_sets_omniharness_app_logger_levels(self) -> None:
        apply_logging_level("debug")
        assert logging.getLogger("omniharness").level == logging.DEBUG
    ...
    def test_defaults_to_info(self) -> None:
        ...
        assert logging.getLogger("omniharness").level == logging.INFO
