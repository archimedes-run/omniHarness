...
class TestWebSearchTool:
    @patch("omniharness.community.firecrawl.tools.FirecrawlApp")
    @patch("omniharness.community.firecrawl.tools.get_app_config")
    def test_search_uses_web_search_config(self, mock_get_app_config, mock_firecrawl_cls):
        ...
        from omniharness.community.firecrawl.tools import web_search_tool
...
class TestWebFetchTool:
    ...
    def test_fetch_uses_web_fetch_config(self, mock_get_app_config, mock_firecrawl_cls):
        ...
        from omniharness.community.firecrawl.tools import web_fetch_tool
