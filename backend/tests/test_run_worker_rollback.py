...
from omniharness.runtime.runs.schemas import RunStatus
from omniharness.runtime.runs.worker import RunContext, _agent_factory_supports_app_config, _build_runtime_context, _install_runtime_context, _rollback_to_pre_run_checkpoint, run_agent
...
def test_agent_factory_supports_app_config_returns_false_when_signature_lookup_fails(monkeypatch):
    ...
    monkeypatch.setattr("omniharness.runtime.runs.worker.inspect.signature", lambda _obj: (_ for _ in ()).throw(ValueError("boom")))
