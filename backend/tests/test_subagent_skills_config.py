...
from omniharness.config.subagents_config import (
...
class TestRegistryCustomAgentLookup:
    ...
    def test_custom_agent_found(self):
        from omniharness.subagents.registry import get_subagent_config
    ...
    def test_get_available_subagent_names_falls_back_when_subagents_app_config_lacks_sandbox(self, monkeypatch):
        from omniharness.subagents import registry as registry_module
        from omniharness.subagents.registry import get_available_subagent_names
    ...
    def test_builtin_takes_priority_over_custom(self):
        ...
        from omniharness.subagents.builtins import BUILTIN_SUBAGENTS
        from omniharness.subagents.registry import get_subagent_config
...
class TestRegistryAvailableNames:
    ...
    def test_includes_builtin_names(self):
        from omniharness.subagents.registry import get_subagent_names
...
class TestRegistryListSubagentsWithCustom:
    ...
    def test_list_includes_custom_agents(self):
        from omniharness.subagents.registry import list_subagents
