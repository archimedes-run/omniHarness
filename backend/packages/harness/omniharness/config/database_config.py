...
Controls BOTH the LangGraph checkpointer and the OmniHarness application
...
({sqlite_dir}/omniharness.db) with WAL journal mode enabled on every
...
class DatabaseConfig(BaseModel):
    ...
    sqlite_dir: str = Field(
        default=".omni-harness/data",
        description=("Directory for the SQLite database file. Both checkpointer and application data share {sqlite_dir}/omniharness.db."),
    )
    postgres_url: str = Field(
        ...
        description=(
            ...
            "Example: postgresql://user:pass@host:5432/omniharness "
    ...
    def sqlite_path(self) -> str:
        ...
        return os.path.join(self._resolved_sqlite_dir, "omniharness.db")
