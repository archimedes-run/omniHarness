...
from omniharness.config.runtime_paths import project_root, resolve_path
...
class SkillsConfig(BaseModel):
    ...
    use: str = Field(
        default="omniharness.skills.storage.local_skill_storage:LocalSkillStorage",
    ...
    def get_skills_path(self) -> Path:
        ...
        Resolution order:
            ...
            2. ``OMNI_HARNESS_SKILLS_PATH`` environment variable
        ...
        if env_path := os.getenv("OMNI_HARNESS_SKILLS_PATH"):
