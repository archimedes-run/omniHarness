...
Usage::
    ...
    from omniharness.runtime.checkpointer.provider import get_checkpointer, checkpointer_context
...
from omniharness.config.checkpointer_config import CheckpointerConfig
