...
and the embedded :class:`~omniharness.client.OmniHarnessClient`.
...
Usage::
    ...
    from omniharness.runtime.store.provider import get_store, store_context
...
from omniharness.runtime.store._sqlite_utils import ensure_sqlite_parent_dir, resolve_sqlite_conn_str
...
def _sync_store_cm(config) -> Iterator[BaseStore]:
    ...
    :class:`~omniharness.config.checkpointer_config.CheckpointerConfig` instance —
...
def get_store() -> BaseStore:
    ...
    from omniharness.config.app_config import _app_config
