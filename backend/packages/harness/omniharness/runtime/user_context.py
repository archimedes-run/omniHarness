...
consumer side of this module lives in ``omniharness.persistence.*``):
...
_current_user: Final[ContextVar[CurrentUser | None]] = ContextVar("omniharness_current_user", default=None)
