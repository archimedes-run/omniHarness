...
:func:`omniharness.runtime.checkpointer.async_provider.make_checkpointer`.

Usage (e.g. FastAPI lifespan)::

    from omniharness.agents.stream_bridge import make_stream_bridge
...
from omniharness.config.stream_bridge_config import get_stream_bridge_config
...
async def make_stream_bridge(app_config: AppConfig | None = None) -> AsyncIterator[StreamBridge]:
    ...
    if config is None or config.type == "memory":
        from omniharness.runtime.stream_bridge.memory import MemoryStreamBridge
