...
from omniharness.skills.types import SKILL_MD_FILE, Skill, SkillCategory  # noqa: F401
...
class SkillStorage(ABC):
    ...
    def validate_skill_markdown_content(name: str, content: str) -> None:
        ...
        from omniharness.skills.validation import _validate_skill_frontmatter
    ...
    def get_skills_root_path(self) -> Path:
        ...
        Origin: ``omniharness.skills.loader.get_skills_root_path``.
        """
    ...
    def _iter_skill_files(self) -> Iterable[tuple[SkillCategory, Path, Path]]:
        ...
        ``omniharness.skills.loader.load_skills``.
        """
    ...
    def read_custom_skill(self, name: str) -> str:
        ...
        Origin: ``omniharness.skills.manager.read_custom_skill_content``.
        """
    ...
    def write_custom_skill(self, name: str, relative_path: str, content: str) -> None:
        ...
        Origin: ``omniharness.skills.manager.atomic_write``.
        """
    ...
    async def ainstall_skill_from_archive(self, archive_path: str | Path) -> dict:
        ...
        Origin: ``omniharness.skills.installer.ainstall_skill_from_archive``.
        """

    def install_skill_from_archive(self, archive_path: str | Path) -> dict:
        """Sync wrapper — delegates to :meth:`ainstall_skill_from_archive`."""
        from omniharness.skills.installer import _run_async_install
    ...
    def custom_skill_exists(self, name: str) -> bool:
        """Origin: ``omniharness.skills.manager.custom_skill_exists``."""

    @abstractmethod
    def public_skill_exists(self, name: str) -> bool:
        """Origin: ``omniharness.skills.manager.public_skill_exists``."""

    @abstractmethod
    def append_history(self, name: str, record: dict) -> None:
        """Append a JSONL history entry for ``name``.

        Origin: ``omniharness.skills.manager.append_history``.
        """
    ...
    def read_history(self, name: str) -> list[dict]:
        ...
        Origin: ``omniharness.skills.manager.read_history``.
        """
    ...
    def get_container_root(self) -> str:
        """Origin: ``omniharness.config.skills_config.SkillsConfig.container_path`` accessor."""
        return self._container_root

    def get_custom_skill_dir(self, name: str) -> Path:
        """Path to ``custom/<name>``. Does not create the directory.

        Origin: ``omniharness.skills.manager.get_custom_skill_dir``.
        """
    ...
    def get_custom_skill_file(self, name: str) -> Path:
        ...
        Origin: ``omniharness.skills.manager.get_custom_skill_file``.
        """
        normalized_name = self.validate_skill_name(name)
    ...
    def get_skill_history_file(self, name: str) -> Path:
        ...
        Origin: ``omniharness.skills.manager.get_skill_history_file``.
        """
        normalized_name = self.validate_skill_name(name)
    ...
    def load_skills(self, *, enabled_only: bool = False) -> list[Skill]:
        ...
        Origin: ``omniharness.skills.loader.load_skills``.
        """
    ...
    def ensure_custom_skill_is_editable(self, name: str) -> None:
        """Origin: ``omniharness.skills.manager.ensure_custom_skill_is_editable``."""
