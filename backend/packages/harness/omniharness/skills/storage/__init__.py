...
Mirrors the pattern used by ``omniharness/sandbox/sandbox_provider.py``.
"""

from __future__ import annotations

from omniharness.skills.storage.local_skill_storage import LocalSkillStorage
from omniharness.skills.storage.skill_storage import SkillStorage
...
def get_or_new_skill_storage(**kwargs) -> SkillStorage:
    ...
    **Singleton** is returned (created on first call, then reused) when neither
    ...
    def _make_storage(skills_config: SkillsConfig, *, host_path: str | None = None, **kwargs) -> SkillStorage:
        from omniharness.reflection import resolve_class
