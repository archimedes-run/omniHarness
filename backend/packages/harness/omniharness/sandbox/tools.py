...
from omniharness.agents.thread_state import ThreadDataState, ThreadState
from omniharness.config import get_app_config
from omniharness.config.paths import VIRTUAL_PATH_PREFIX
from omniharness.sandbox.exceptions import (
    SandboxError,
    SandboxNotFoundError,
    SandboxRuntimeError,
)
from omniharness.sandbox.file_operation_lock import get_file_operation_lock
from omniharness.sandbox.sandbox import Sandbox
from omniharness.sandbox.sandbox_provider import get_sandbox_provider
from omniharness.sandbox.search import GrepMatch
from omniharness.sandbox.security import LOCAL_HOST_BASH_DISABLED_MESSAGE, is_host_bash_allowed
...
def _get_mcp_allowed_paths() -> list[str]:
    ...
    allowed_paths = []
    try:
        from omniharness.config.extensions_config import get_extensions_config
