...
DEFAULT_IMAGE = "omni-harness-sandbox:latest"
DEFAULT_PORT = 8080
...
class AioSandboxProvider(SandboxProvider):
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses OMNI_HARNESS_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("OMNI_HARNESS_HOST_SKILLS_PATH") or str(skills_path)
