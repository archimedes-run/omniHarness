...
from omniharness.runtime import RunContext, RunManager, StreamBridge
from omniharness.runtime.events.store.base import RunEventStore
from omniharness.runtime.runs.store.base import RunStore

if TYPE_CHECKING:
    from app.gateway.auth.local_provider import LocalAuthProvider
    from app.gateway.auth.repositories.sqlite import SQLiteUserRepository
    from omniharness.persistence.thread_meta.base import ThreadMetaStore
...
async def langgraph_runtime(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    Usage in ``app.py``::
        ...
        async with langgraph_runtime(app):
            yield
    """
    from omniharness.persistence.engine import close_engine, get_session_factory, init_engine_from_config
    from omniharness.runtime import make_store, make_stream_bridge
    from omniharness.runtime.checkpointer.async_provider import make_checkpointer
    from omniharness.runtime.events.store import make_run_event_store
    ...
    async with AsyncExitStack() as stack:
        ...
        if sf is not None:
            ...
            from omniharness.persistence.workflow_artifact_links import WorkflowArtifactLinkRepository
            from omniharness.persistence.workflow_runs import WorkflowRunRepository
            from omniharness.persistence.workflow_step_runs import WorkflowStepRunRepository
            from omniharness.persistence.workflow_versions import WorkflowVersionRepository
            ...
            app.state.workflow_version_repo = None
            app.state.workflow_run_repo = None
