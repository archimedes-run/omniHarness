...
:class:`omniharness.agents.runs.RunManager` and
:class:`omniharness.agents.stream_bridge.StreamBridge`.
...
from omniharness.runtime import RunRecord, serialize_channel_values
...
class RunCreateRequest(BaseModel):
    ...
    context: dict[str, Any] | None = Field(default=None, description="OmniHarness context overrides (model_name, thinking_enabled, etc.)")
