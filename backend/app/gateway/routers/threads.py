...
:func:`omniharness.runtime.serialization.serialize_channel_values` to
...
from omniharness.config.paths import Paths, get_paths
from omniharness.runtime import serialize_channel_values
from omniharness.runtime.user_context import get_effective_user_id
from omniharness.utils.time import coerce_iso, now_iso
...
async def delete_thread_data(thread_id: str, request: Request) -> ThreadDeleteResponse:
    ...
    Cleans OmniHarness-managed thread directories, removes checkpoint data,
...
async def get_thread_history(thread_id: str, body: ThreadHistoryRequest, request: Request) -> list[HistoryEntry]:
    ...
    :func:`~omniharness.runtime.serialization.serialize_channel_values`.
