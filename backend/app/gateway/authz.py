"""Authorization decorators and context for OmniHarness.
...
def _make_test_request_stub() -> Any:
    ...
    """
    return SimpleNamespace(state=SimpleNamespace(), cookies={}, _omniharness_test_bypass_auth=True)
...
def require_auth[**P, T](func: Callable[P, T]) -> Callable[P, T]:
    ...
    async def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        if getattr(request, "_omniharness_test_bypass_auth", False):
