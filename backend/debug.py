...
Requirements:
    ...
    resolves omniharness-harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the omniharness imports until *after* logging is installed
    # so that any import-time side effects (e.g. omniharness.agents starts a
    ...
    from omniharness.mcp import initialize_mcp_tools
