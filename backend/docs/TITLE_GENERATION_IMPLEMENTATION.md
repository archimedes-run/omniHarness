...
#### [`packages/harness/omniharness/agents/thread_state.py`](../packages/harness/omniharness/agents/thread_state.py)
- ✅ 添加 `title: str | None = None` 字段到 `ThreadState`

#### [`packages/harness/omniharness/config/title_config.py`](../packages/harness/omniharness/config/title_config.py) (新建)
- ✅ 创建 `TitleConfig` 配置类
...
#### [`packages/harness/omniharness/agents/middlewares/title_middleware.py`](../packages/harness/omniharness/agents/middlewares/title_middleware.py) (新建)
...
#### [`packages/harness/omniharness/config/app_config.py`](../packages/harness/omniharness/config/app_config.py)
- ✅ 导入 `load_title_config_from_dict`
- ✅ 在 `from_file()` 中加载 title 配置

#### [`packages/harness/omniharness/agents/lead_agent/agent.py`](../packages/harness/omniharness/agents/lead_agent/agent.py)
- ✅ 导入 `TitleMiddleware`
...
checkpointer = SqliteSaver.from_conn_string("omniharness.db")
```
