...
This document provides a complete reference for the OmniHarness backend APIs.

## Overview

OmniHarness backend exposes two sets of APIs:
...
OmniHarness's own Gateway and IM-channel paths mitigate this by defaulting to
  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".omni-harness/threads/abc123/user-data/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/uploads/document.pdf",
      "artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".omni-harness/threads/abc123/user-data/uploads/document.md",
...
Remove OmniHarness-managed local thread files under `.omni-harness/threads/{thread_id}` after the LangGraph thread itself has been deleted.
...
Currently, OmniHarness does not implement authentication. All APIs are accessible without credentials.

Note: This is about OmniHarness API authentication. MCP outbound connections can still use OAuth for configured HTTP/SSE MCP servers.
...
> The `/api/langgraph/*` endpoints bypass OmniHarness's Gateway and inherit
