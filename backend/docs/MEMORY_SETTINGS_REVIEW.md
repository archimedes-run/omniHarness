...
1. Start OmniHarness locally using any working development setup you already use.
   ...
   If you already have OmniHarness running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.omni-harness/memory.json`
