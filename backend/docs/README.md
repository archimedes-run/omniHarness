...
This directory contains detailed documentation for the OmniHarness backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs OmniHarnessClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to OmniHarness?** Start with [SETUP.md](SETUP.md) for quick installation
