...
{
  "graphs": {
    "lead_agent": "omniharness.agents:lead_agent"
  },
...
```python
from omniharness.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from omniharness.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/omniharness/agents/thread_state.py`](../packages/harness/omniharness/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/omniharness/agents/middlewares/title_middleware.py`](../packages/harness/omniharness/agents/middlewares/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/omniharness/config/title_config.py`](../packages/harness/omniharness/config/title_config.py) - 配置管理
- [`config.yaml`](../../config.example.yaml) - 配置文件
- [`packages/harness/omniharness/agents/lead_agent/agent.py`](../packages/harness/omniharness/agents/lead_agent/agent.py) - Middleware 注册
